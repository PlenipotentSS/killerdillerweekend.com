...
function sc_custom_header_style() {
	...
	if ( !empty( $image ) && $default !== $image )
		...
		/* Stevenson Changed Header!! */
		printf( '<style type="text/css">#header #title-area #title { background: url(%s) no-repeat; background-repeat: no-repeat;
background-position: center center;
background-size: contain;}</style>', $image );
...
function cs_event_description() {
	...
	$register = '<div class="one-third"><a class="register" onclick="' . $eventTracking .'" target="new" href="' . esc_url( genesis_get_option( 'event_register_link', 'social-coup' ) ) . '">
